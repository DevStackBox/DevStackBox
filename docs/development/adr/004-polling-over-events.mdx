...
- Tauri Channels should be used for log streaming when that feature is implemented (see `roadmap` Phase 3.2). This ADR does not prevent using channels for log streaming - just for service status.
