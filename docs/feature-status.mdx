...
| Phase                        | Status | Notes                                                                                                                                                                                                                                                     |
| ---------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 1 - Core Stability     | DONE   | Items 1.1-1.8 complete. `cargo check` is clean; current toolchain clippy follow-up is tracked in advanced/troubleshooting ISSUE-017.                                                                                                                               |
...
| Version         | Key Changes                                                                                                               |
| --------------- | ------------------------------------------------------------------------------------------------------------------------- |
| v0.1.8          | Branding and logo refresh; signed NSIS installer; in-place upgrade with `www` preservation; MDX docs site                 |
| v0.1.7          | PHP 8.4 CGI compatibility (session.sid_*, error_reporting, html_errors); configVersion 7 vhost fix; NSIS-only releases   |
